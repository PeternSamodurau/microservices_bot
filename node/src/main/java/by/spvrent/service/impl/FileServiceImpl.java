...
public class FileServiceImpl implements FileService {
    ...
    public AppDocument processDoc(Message telegramMessage) {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            AppBinaryContent persistentBinaryContent = getPersistentBinaryContent(response);
    ...
    private AppPhoto buildTransientAppPhoto(PhotoSize telegramPhoto, AppBinaryContent persistentBinaryContent) {
